    ...
    <div>
      <div className="block p-0 border-0 m-0" data-scout-rendered="true">
        <p className="block p-0 border-0 m-0 h-full text-base">
          ...
          <a 
            className="text-green-500 underline hover:text-green-700 visited:text-green-500"
            href="https://www.recurse.com/scout/click?t=ba46ea16fafed13b3f8ccacb0ce83ad1"
          >
